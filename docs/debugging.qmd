...
[here](https://github.com/datamade/la-metro-dashboard/blob/master/dags/hourly_processing.py).
...
**Where it lives:** [LA Metro Councilmatic](https://github.com/datamade/la-metro-councilmatic/blob/master/lametro/management/commands/compile_pdfs.py)<br />
...
**Past issues:**
<!--- Todo: figure out what i should do with this solr bit --->
...
also causing this command to fail. If you are seeing this error, see [our documentation on Commands to Know](./commands-to-know.qmd)
...
<!--- Todo: write about how to shell in and get an object with this slug --->
