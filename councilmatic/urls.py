...
from lametro.views import LABillDetail, LABoardMembersView, LAMetroAboutView, LACommitteeDetailView, LAPersonDetailView, LAEventDetailView
...
urlpatterns = [
    ...
    url(r'^event/(?P<slug>[^/]+)/$', LAEventDetailView.as_view(), name='event'),
