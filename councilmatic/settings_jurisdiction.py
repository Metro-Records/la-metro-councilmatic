...
OCD_JURISDICTION_IDS = [
    "ocd-jurisdiction/country:us/state:ca/county:los_angeles/transit_authority"
]
...
BILL_STATUS_DESCRIPTIONS = {
    ...
    "NOT DISCUSSED": {"definition": "Item was not discussed.", "search_term": "Active"},
...
MEMBER_BIOS = {
    ...
    "lindsey-horvath": "Supervisor Lindsey P. Horvath was elected to the Los Angeles County Board of Supervisors on November 8, 2022 and assumed office on December 5, 2022, after serving as a City Councilmember and the longest consecutivelyserving Mayor for the City of West Hollywood. Supervisor Horvath’s career has been defined by tackling the hardest problems, building diverse coalitions, and delivering results for her community.<br/><br/>Supervisor Horvath’s commitment to serving others was shaped by her family and faith, which instilled in her a strong work ethic and made her a tireless advocate in addressing the complex problems facing Angelenos throughout LA County. Supervisor Lindsey P. Horvath made history as the youngest woman to ever be elected to the Los Angeles County Board of Supervisors. She is the first millennial, and currently the only renter to serve on the Board, bringing a much-needed perspective to LA County leadership. Supervisor Horvath has a long history of civic and social justice advocacy. She has spearheaded policies to make West Hollywood an “Age-Friendly Community” to better serve residents of all ages. She also led the City to become the first in the nation to impose financial sanctions on Arizona for its discriminatory, anti-immigration SB-1070 law. Supervisor Horvath created the first-ever West Hollywood Community Response Team to Domestic Violence. She has worked on a broad range of transportation and mobility issues, from her service as a Transportation Commissioner to championing Metro rail projects in the District. She initiated the West Hollywood Bicycle Task Force, and through her leadership, West Hollywood was named “The Most Walkable” city in the entire state.<br/><br/>Supervisor Horvath is widely known for her leadership on women’s issues and served as a Global Coordinator for One Billion Rising, a global campaign of the V-Day movement to end violence against women and girls. She was the founding President of the Hollywood Chapter of the National Organization for Women (NOW) and previously served as President of National Women’s Political Caucus (NWPC) - LA Westside. She is also a champion for LGBTQ+ rights, having served as a Board member of the Victory Fund and a founding Board member of the NOH8 Campaign. In 2009, she represented the City of West Hollywood in the National Equality March in Washington DC. She has also advocated for LGBTQ+ older adults through her work on the Board of Services & Advocacy for GLBT Elders (SAGE).<br/><br/>Supervisor Horvath served on the West Hollywood City Council for nine years, appointed in 2009, elected in 2015, and re-elected in 2019. In addition to her work as a Councilwoman and Mayor, Supervisor Horvath previously served in a number of roles, including: President of the California Contract Cities Association (CCCA); Board Member for CalCities (formerly the League of California Cities); Board Member for the National League of Cities (NLC); President of Women in Municipal Government (WIMG) for the National League of Cities; Chair of the Contract Cities Liability Trust Fund Claims Board & Oversight Committee; and Executive Committee Member and Legislative & Regulatory Chair for Clean Power Alliance of Southern California.<br/><br/>Supervisor Horvath received her Bachelor of Arts from the University of Notre Dame and a Certificate in Nonprofit Management & Fundraising from UCLA Extension. She resides in West Hollywood with her dog, Winston.",
    "karen-bass": "Karen Bass is the 43rd Mayor of Los Angeles and the first woman and second African American to be elected as the city's chief executive. With an agenda focused on bringing urgency, accountability, and a new direction to Los Angeles, she will start her term with a focus on housing people immediately and increasing safety and opportunity in every part of Los Angeles.<br /><br />A daughter of our city, Mayor Bass was raised with her three brothers in the Venice/Fairfax neighborhood and is a proud graduate of Hamilton High School. After serving as a front-line healthcare provider as a nurse and as a Physician Assistant, Mayor Bass founded the Community Coalition to organize the predominantly Black and Latino residents of South L.A. against substance abuse, poverty and crime, and to pioneer strategies to address the root causes behind the challenges faced by underserved neighborhoods.<br /><br />She then went on to represent Los Angeles in the State Assembly and was elected by her peers to serve as Speaker, making her the first African American woman to ever lead a state legislative body in the history of the United States. Her time in leadership intersected with the Great Recession, and she was honored with the John F. Kennedy Profile in Courage Award for reaching across party lines and making tough decisions to keep the state from bankruptcy while protecting vital services.<br /><br />While representing Los Angeles and Culver City in Congress, Mayor Bass helped protect small businesses during the pandemic, created policy to drive local jobs from federal infrastructure funding, and led the passage of what the Los Angeles Times called “the most significant child welfare policy reform in decades.”<br /><br />Mayor Bass earned her bachelor's degree in health sciences from CSU Dominguez Hills before graduating from the USC Keck School of Medicine Physician Assistant Program and earning her masters degree in social work from USC.<br /><br />Mayor Bass’s oldest daughter Emilia planned to follow in her mother’s footsteps working for social change. The Mayor-elect continues to be inspired by Emilia and her son-in-law Michael’s passion for life. She has three other children, Scythia, Omar and Yvette, and two grandchildren, Michael and Henry, who live in the Los Angeles area.",
}
