...
COMMITTEE_DESCRIPTIONS = {
    ...
    'planning-and-programming-committee-e754ae1125d4': 'The Planning and Programming Committee mainly discusses matters related to Metro\'s transportation programs, long range and short range plans for all modes of transportation, strategic plans, environmental impacts and clearances for future projects, grant applications, Metro\'s Call for Projects program, countywide transportation improvements, and related policies, as well as Metro\'s local regional relationships.',
...
MANUAL_HEADSHOTS = {
    ...
    'robert-garcia-cbe3d3bf21e6': {'source': '', 'image': 'manual-headshots/robert-garcia.jpg' },
