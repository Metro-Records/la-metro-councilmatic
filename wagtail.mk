...
legislative_data : db
	...
	docker compose run --rm -e DATABASE_URL=${DATABASE_URL} app python manage.py refresh_guid
	docker compose run --rm -e DATABASE_URL=${DATABASE_URL} app python manage.py update_index
